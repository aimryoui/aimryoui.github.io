        ...
        <>
            ...
            <div className={cn("bg-background flex items-stretch")}>
                ...
                <div className={cn("bg-highlighted/10 w-2/5 p-2")}>
                    <div
                        className={cn(
                            "bg-background border-highlighted grid size-full place-items-center rounded-2xl border bg-[radial-gradient(oklch(from_var(--stroke-foreground)_l_c_h/40%)_.125rem,transparent_.125rem),radial-gradient(oklch(from_var(--stroke-foreground)_l_c_h/40%)_.125rem,transparent_.125rem)] bg-size-[.75rem_.75rem] bg-fixed bg-position-[0_0,.375rem_.375rem]"
                        )}
                    >
                        <svg
