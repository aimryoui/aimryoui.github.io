...
function NoAIOverlay() {
    ...
    return (
        <div
            className={cn(
                "inset-x-0 z-80 border-y border-dashed border-stroke anchored/no-ai-placeholder top-anchor-top-0 h-anchor-height-0 transition-[background-color] duration-500",
        ...
        >
            <div
                className={cn(
                    "sticky top-0 flex h-screen min-h-180 flex-col justify-center gap-8 text-default",
                    isActive && "text-white"
                )}
            >
