            ...
            },
            {
                ...
                icon: (
                    ...
                    >
                        <path
                            fill="currentColor"
                            d="M20.587 17.374a2.24 2.24 0 0 1 2.236 2.236 2.23 2.23 0 0 1-2.236 2.238 2.24 2.24 0 0 1-2.237-2.238 2.24 2.24 0 0 1 2.237-2.236M32.363 17.343a2.25 2.25 0 0 1 2.253 2.252 2.25 2.25 0 0 1-2.253 2.252 2.25 2.25 0 0 1-2.252-2.252 2.25 2.25 0 0 1 2.252-2.252"
                        />
                        <path
                            fill="currentColor"
                            d="M21.77 0c4.886 0 7.742.717 10.276 2.076s4.534 3.344 5.878 5.878c.896 1.671 1.51 3.483 1.827 5.923q.09.687.147 1.445.044.583.07 1.212.032.808.032 1.7v3.543c0 4.887-.718 7.743-2.077 10.279q-.344.64-.74 1.233l-.013.008a14 14 0 0 1-5.124 4.627C29.512 39.283 26.656 40 21.77 40H18.23c-4.886 0-7.74-.717-10.275-2.076-2.534-1.359-4.534-3.344-5.878-5.878C.717 29.512 0 26.656 0 21.772V18.23c0-4.886.717-7.741 2.076-10.276C3.435 5.42 5.42 3.42 7.954 2.076q.538-.29 1.107-.542l.011-.01a15.4 15.4 0 0 1 2.286-.796l.243-.061.034-.009q.248-.061.504-.116l.104-.022q.898-.19 1.928-.311l.06-.007q.31-.035.633-.064L15 .126a30 30 0 0 1 1.326-.085q.123-.007.246-.01.35-.014.716-.021l.043-.002Q17.758 0 18.207 0zM7.026 3.814C5.33 5 3.963 6.553 2.958 8.427 1.699 10.775 1 13.455 1 18.23v3.541c0 4.476.614 7.111 1.729 9.358l.229.444.002.004c1.248 2.355 3.103 4.198 5.467 5.465C10.775 38.301 13.455 39 18.229 39h3.541c4.775 0 7.455-.7 9.803-1.958l.004-.002a13 13 0 0 0 3.342-2.526c-6.837 3.12-16.52 2.902-22.958-.656-1.655.804-3.986 1.335-5.85 1.13-.321-.031-.398-.154-.184-.352 1.313-1.314 2.153-3.558 1.283-4.841l-.022-.034C2.061 22.896 2.007 10.79 7.026 3.814m13.56 11.993a3.806 3.806 0 0 0-3.804 3.803 3.806 3.806 0 0 0 6.059 3.063v.025c0 .35.304.654.669.654h.898V16.02h-1.567v.52a3.8 3.8 0 0 0-2.254-.732m11.777-.062a3.84 3.84 0 0 0-3.834 3.834 3.84 3.84 0 0 0 3.834 3.835 3.84 3.84 0 0 0 3.835-3.835 3.84 3.84 0 0 0-3.835-3.834M8.566 15.32h.006v.003h5.41l-5.34 6.617c-.167.243-.29.471-.29.988v.427h.007v.002h7.365c.364 0 .67-.305.67-.67v-.897h-.007v-.003h-5.68l5.017-6.297c.076-.09.214-.257.274-.334l.03-.046c.29-.426.35-.791.35-1.232v-.229h-.006v-.002H8.566zm17.18 7.471c0 .27.19.503.456.553q.06.013.12.013h1.11v-9.708h-.014v-.002h-1.673z"
                        />
                    </svg>
                ),
                links: {
