...
function ArticleIndex({ toc }: ArticleIndexProps) {
    ...
    return (
        <aside
            className={cn(
                "sticky end-[calc(var(--body-safe-zone-left)+var(--px))] top-0 z-[56] order-9 -mt-space flex h-dvh w-sidebar shrink-0 flex-col overscroll-contain bg-background xl:hidden",
                {
