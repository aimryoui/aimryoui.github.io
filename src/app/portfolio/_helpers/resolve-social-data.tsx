...
> = {
    behance: {
        ...
        label: "View this project on Behance"
    },
    dribbble: {
        color: {
            default: "bg-[#ea4c89]",
        ...
        label: "View this project on Dribbble"
    },
    "product-website": {
        color: {
            default: "bg-[#b18c1b]",
        ...
        label: "Visit this product website"
    }
}

type SocialData = Project["social"]

function resolveSocialData(social?: SocialData) {
    if (!social) return null

    const activeSocial = Object.entries(social).find(([_, url]) => !!url)
    if (!activeSocial) return null

    const type = activeSocial[0]
    const url = activeSocial[1]
    const uiConfig = SOCIAL_UI_MAP[type]

    return {
        type,
        url,
        label: uiConfig.label || "View this project link",
        icon: uiConfig.icon,
...
export { resolveSocialData, SOCIAL_UI_MAP }
