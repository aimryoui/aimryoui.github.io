...
{/* Import các component layout vào body MDX */}
{/* Lưu ý: Các component này sẽ được pass vào qua MDXProvider ở bước sau */}
...
<MediaFrame className="grid grid-cols-2 grid-rows-2">
    <Image
        placeholderPriority
