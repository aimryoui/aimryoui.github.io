            ...
            >
                <DrawerPrimitive.Popup
                    ...
                    className={cn(
                        ...
                        "pb-[max(0px,calc(var(--drawer-snap-point-offset)+var(--drawer-swipe-movement-y)))] data-[current-snap-points=1]:rounded-t-none",
                        ...
                        // Sizing.
                        "[--drawer-content-height:--drawer-height,auto] data-[swipe-axis=y]:data-[snap-points]:[--drawer-content-height:100dvh] data-[swipe-axis=y]:[--drawer-content-max-height:calc(100dvh+theme(spacing.12))] data-[swipe-axis=x]:[--drawer-content-width:75%] data-[swipe-axis=x]:sm:[--drawer-content-width:24rem]",
                        // Stack.
...
function DrawerHeader({ className, ...props }: React.ComponentProps<"div">) {
    return (
        <div
            ...
            className={cn(
                "flex shrink-0 flex-col gap-1.5 p-6 pb-0 text-left group-data-[swipe-axis=y]/drawer-popup:text-center md:gap-0.5",
                className
            )}
            {...props}
        />
