...
function InputGroup({ className, ...props }: GroupProps) {
    return (
        <Group
            ...
            role="group"
            className={cn(
                "group/input-group relative flex h-9 w-full min-w-0 items-center rounded-xlg ring ring-inset ring-input has-[>textarea]:h-auto",
                {
                    dark: "bg-input/25",
                    hover: [
                        "bg-element-hover/80",
...
function InputGroupAddon({
    ...
    align = "inline-start",
    ...props
}: GroupProps & VariantProps<typeof inputGroupAddonVariants>) {
    return (
        <Group
            role="group"
